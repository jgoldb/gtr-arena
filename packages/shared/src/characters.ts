...
import {
  ...
  Shank, PocketSand, StickyFingers, CrackRock, DumpsterDive, TweakerSprint,
  PvPTrinket,
  TweakingBuff,
} from './abilities.js';
...
export const CHARACTERS: Record<CharacterId, CharacterStats> = {
  ...
  'crackhead': {
    ...
    hpRegen: 28,
    manaRegen: 16,
    abilities: [Shank, PocketSand, StickyFingers, CrackRock, DumpsterDive, TweakerSprint, null, null, PvPTrinket],
