export interface AuthBackgroundHandle {
  destroy(): void;
}

export function initAuthBackground(container: HTMLDivElement): AuthBackgroundHandle {
  let animationFrameId = 0;
    ...
    container.appendChild(nickBubbleEl);
